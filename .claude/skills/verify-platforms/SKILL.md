...
```bash
xcodebuild -scheme MatrixSwiftBaseUI -destination 'generic/platform=iOS' build -quiet
xcodebuild -scheme MatrixSwiftBaseUI -destination 'generic/platform=macOS' build -quiet
xcodebuild -scheme MatrixSwiftBaseUI -destination 'generic/platform=tvOS' build -quiet
xcodebuild -scheme MatrixSwiftBaseUI -destination 'generic/platform=watchOS' build -quiet
```
